import React, { createContext, useReducer, useEffect, useMemo, useContext, useDebugValue } from 'react';
...
function CartProvider({
  ...
  return (
    React.createElement(CartContext.Provider, { value: contextValue, __self: this, __source: {fileName: _jsxFileName, lineNumber: 93}}, children)
  )
}
...
function DebugCart(props) {
  ...
  const cartPropertyRows = Object.entries(cart)
    ...
    .map(([key, value]) => (
      React.createElement('tr', { key: key, __self: this, __source: {fileName: _jsxFileName, lineNumber: 189}}
        , React.createElement('td', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 190}}, key)
        , React.createElement('td', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 191}}
          , typeof value === 'object' ? (
            React.createElement('button', { onClick: () => console.log(value), __self: this, __source: {fileName: _jsxFileName, lineNumber: 193}}, "Log value" )
          ) : (
  ...
  return (
    React.createElement('table', {
      ...
      , React.createElement('thead', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 215}}
        , React.createElement('tr', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 216}}
          , React.createElement('th', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 217}}, "Key")
          , React.createElement('th', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 218}}, "Value")
        )
      )
      , React.createElement('tbody', {__self: this, __source: {fileName: _jsxFileName, lineNumber: 221}}, cartPropertyRows)
    )
  )
}

export { CartContext, CartProvider, DebugCart, formatCurrencyString, isClient, useShoppingCart };

(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.UseShoppingCartCore = {}, global.uuid));
	...
	function Entry({
	  ...
	  const id =
	    product.id || product.price_id || product.sku_id || product.sku || uuid.v4();
	...
	function updateQuantity({ state, id, quantity, language, currency }) {
	...
	const handleStripe = (store) => (next) => async (action) => {
	  if (action.type === 'cart/redirectToCheckout') {
	    try {
	      ...
	      if (_optionalChain$1([action, 'access', _ => _.payload, 'optionalAccess', _2 => _2.sessionId])) {
	...
	*/
	...
	function persistStore(store, options, cb) {
	  ...
	  var persistor = _objectSpread$2({}, _pStore, {
	...
	// for non react apps
	function createPersistedStore(store) {
